			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container">
						...
						<?= validation_errors() ?>
						<?= form_open('admin/produk/produk_editsave/' . $produk['id_produk']) ?>
						...
						<div class="mb-3">
							...
							<input type="text" name="harga_produk" class="form-control" id="harga_produk" value="<?= $produk['harga_produk'] ?>" required>
						</div>
						...
						<div class="mb-3">
							...
							<p class="form-text">Gambar saat ini: <strong><?= $produk['gambar_produk'] ?></strong></p>
						</div>
						...
						<div class="mb-3">
							...
							<textarea name="keterangan_produk" class="form-control" id="keterangan_produk" rows="4" required><?= $produk['keterangan_produk'] ?></textarea>
						</div>
