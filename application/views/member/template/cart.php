...
<script>
  ...
  <script type="module" src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.esm.js"></script> ketika menekan btn byar maka di arahkan ke popup ini <!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
          ...
          <div class="card" id="print">
            ...
            <div class="card-body">
              ...
              <ul class="list-unstyled">
                <li class="d-flex justify-content-between"><strong>Total:</strong><span id="modal-total">Rp <?= number_format($total, 0, ',', '.') ?></span></li>
              </ul>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-success" form="payment-form">Bayar</button>
        </div>
      </div>
    </div>
  </div>
